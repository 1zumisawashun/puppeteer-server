...
export const nojima = {
  url: 'https://online.nojima.co.jp/app/catalog/list/init?searchCategoryCode=0&searchMethod=0&searchWord=Meetingowl',
  pricePath: 'div .price',
...
export const rakuten = {
  url: 'https://product.rakuten.co.jp/product/-/9d9040af1dba7d037cd8b172659c7442/item/?l2-id=pdt_item_more#price_compare',
  pricePath: 'td .itemPrice3',
  namePath: 'td .shop_link',
};
export const paypay = {
  url: 'https://paypaymall.yahoo.co.jp/search?p=meeting%20owl%20pro&cid=&brandid=&kspec=&b=1',
